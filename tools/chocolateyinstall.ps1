...
$installerType = 'MSI'
$url = 'http://download.splunk.com/products/splunk/releases/6.3.0/universalforwarder/windows/splunkforwarder-6.3.0-aa7d4b1ccb80-x86-release.msi'
$url64 = 'http://download.splunk.com/products/splunk/releases/6.3.0/universalforwarder/windows/splunkforwarder-6.3.0-aa7d4b1ccb80-x64-release.msi'
